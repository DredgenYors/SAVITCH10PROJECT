...
#ifndef BAG6_H 
#define BAG6_H
#include <cstdlib> // Provides NULL and size_t   // Provides binary_tree_node and related functions
#include "bintree.h"
...
namespace main_savitch_10
{
    ...
    private:
        ...
        size_type bst_remove_all(binary_tree_node<Item>*& root_ptr, const Item& target);
